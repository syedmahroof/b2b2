...
@extends('buyer.layouts.master-sub') <!-- Extending the master.blade.php template -->
@section('content')
                    ...
                    <div class="col-md-6 d-flex flex-column">
                        <div class="card flex-grow-1 mb-md-0">
                            <div class="card-body">
                                ...
                                <form action="{{ route('buyer.submit.login') }}" method="post">
                                    @csrf
                                    <div class="form-group"><label>Email address</label> <input name="email"
                                            type="email" class="form-control" placeholder="Enter email"></div>
                                        ...
                                        <div class="form-check">
                                            <span class="form-check-input input-check">
                                                <span class="input-check__body">
                                                    ...
                                                    <span class="input-check__box"></span> <svg class="input-check__icon"
