					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							...
							<div class="m-0">
								...
								<a href="../../demo14/dist/authentication/layouts/fancy/sign-in.html" class="link-primary fw-bold fs-5" data-kt-translate="two-step-head-resend">Resend</a>
						...
						<div class="py-20">
							<!--begin::Form-->
							<form class="form w-100 mb-10" novalidate="novalidate" data-kt-redirect-url="../../demo14/dist/index.html" id="kt_sing_in_two_steps_form">
								<!--begin::Icon-->
