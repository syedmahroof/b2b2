                                ...
                                @foreach ($sliders as $slider)
                                    <a class="block-slideshow__slide" href="#">
                                        <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop"
                                            style="background-image: url('{{ asset('/sliders/' . $slider->attachment) }}')">
                                        </div>
                                        <div class="block-slideshow__slide-image block-slideshow__slide-image--mobile"
                                            style="background-image: url('images/slides/slide-1-mobile.jpg')"></div>
                                        <div class="block-slideshow__slide-content">
                                            <div class="block-slideshow__slide-title">{{ $slider->title }}<br>Plumbing
                                                products
                                            </div>
                        ...
                        @foreach ($latestNews as $news)
                            <div class="post-card">
                                ...
                                <div class="post-card__info">
                                    ...
                                    <div class="post-card__name"><a href="#">{{ $news->title }}</a></div>
                                    <div class="post-card__date">October 19, 2019</div>
                                    <div class="post-card__content">{{ $news->content }}</div>
                    ...
                    <div class="owl-carousel">
                        ...
                        @foreach ($suppliers as $suppliers)
                            <div class="block-brands__item">
                                <a href="#">
                                    <img src="{{ asset($suppliers->logo) }}" alt="">
                                </a>
                            </div>
                        @endforeach
                            ...
                            @foreach ($latestProducts as $latestProduct)
                                <div class="block-product-columns__item">
                                    <div
                                        ...
                                        <div class="product-card__image product-image"><a href="{{ route('buyer.product.details', $latestProduct->id) }}"
                                                class="product-image__body"><img class="product-image__img"
                                                    src="{{ asset($latestProduct->featured_image) }}"
                                                    alt=""></a></div>
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a
                                                    href="{{ route('buyer.product.details', $latestProduct->id) }}">{{ $latestProduct->name }}</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                ...
                                <div class="block-product-columns__item">
                                    <div
                                        ...
                                        <div class="product-card__image product-image">
                                            <a href="{{ route('buyer.product.details', $specialOfferProduct->id) }}"
                                                class="product-image__body">
                                                <img class="product-image__img"
                                                    src="{{ asset($specialOfferProduct->featured_image) }}"
                                                    alt=""></a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a
                                                    href="{{ route('buyer.product.details', $specialOfferProduct->id) }}">{{ $specialOfferProduct->name }}</a></div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                                        <div class="rating__body"><svg
                                ...
                                <div class="block-product-columns__item">
                                    <div
                                        ...
                                        <div class="product-card__image product-image"><a
                                                href="{{ route('buyer.product.details', $bestSeller->id) }}"
                                                class="product-image__body"><img class="product-image__img"
                                                    src="{{ asset($bestSeller->featured_image) }}" alt=""></a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a
                                                    href="{{ route('buyer.product.details', $bestSeller->id) }}">{{ $bestSeller->name }}</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
