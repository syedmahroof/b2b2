            ...
            <div class="grid w-full grid-cols-1 mx-auto lg:grid-cols-3">
                ...
                <div class="py-6">
                    <div class="flex items-start md:justify-center">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-y-charcoal">Inclusive member benefits</p>
                        </div>
                ...
                <div class="py-6">
                    <div class="flex items-start md:justify-center">
                        ...
                        <div class="flex flex-col">
                            <h1 class="text-y-charcoal font-main text-4xl md:text-5xl">100m</h1>
                            <p class="text-y-charcoal">From Chapel St</p>
                        </div>
                ...
                <div class="py-6">
                    <div class="flex items-start md:justify-center">
                        ...
                        <div class="flex flex-col">
                            <h1 class="text-y-charcoal font-main text-4xl md:text-5xl">24/7</h1>
                            <p class="text-y-charcoal">Full Access</p>
                        </div>
