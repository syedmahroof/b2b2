        ...
        <div class="site-header__topbar topbar">
            <div class="topbar__container container">
                <div class="topbar__row">
                    ...
                    <div class="topbar__item topbar__item--link"><a class="topbar-link"
                       href="{{route('supplier.login')}}">Supplier</a></div>
                    ...
                    <div class="nav-panel__row">
                        ...
                        <div class="nav-panel__indicators">
                            ...
                            <div class="indicator indicator--trigger--click">
                                ...
                                @if (!auth()->guard('buyer')->check())
                                    <a href="{{ route('buyer.login') }}" class="pw"><span
                                            class="indicator__area"><svg width="20px" height="20px">
                                        ...
                                        <div class="account-menu">
                                            ...
                                            <div class="account-menu__divider"></div><a href="account-dashboard.html"
                                                ...
                                                <div class="account-menu__user-info">
                                                    <div class="account-menu__user-name">{{auth()->guard('buyer')->user()->name}}</div>
                                                    <div class="account-menu__user-email">{{auth()->guard('buyer')->user()->email}}</div>
                                                </div>
                                            </a>
