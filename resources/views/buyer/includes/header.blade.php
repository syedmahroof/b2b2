{{-- <header id="header" data-controller="search" data-search-url-value="tv_search_inspiration"
    ...
    <div class="inner">
        <div class="header-main ">
            <a href="{{route('buyer.home')}}" class="header-main__logo" aria-label="Awwwards">
            ...
            <div class="header-search" data-search-target="search">
                <div class="header-search__overlay" data-search-target="overlay" data-action="click->search#close">
                </div>
                ...
                <div class="header-search__results">
                    <div class="content-tabs">
                        <div class="content-tabs__item active" id="search-default" data-search-target="defaultView">
                                    ...
                                    <div class="header-search__row hidden-sm">
                                        ...
                                        <ul class="list-featured">
                                            <li>
                                                <figure>
                                                    <a href="websites/sites_of_the_day/index.html">
                                                        <img width="143" height="88" class="list-featured__img"
                                                            loading="lazy"
                                            ...
                                            <li>
                                                ...
                                                <a class="list-featured__title" href="websites/index.html">Websites</a>
                                            </li>
                                            <li>
                                                <figure>
                                            ...
                                            <li>
                                                ...
                                                <a class="list-featured__title" href="academy/index.html">Courses</a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="header-main__right">
                    ...
                    @if (auth()->guard('buyer')->check())
                        <div class="header-main__user">
                            ...
                            <div class="bt-dropdown-user">
                                <figure id="js-user-details"
                                    
                                    class="circle-avatar">
                                    <a class="bt-dropdown-user__link" href="{{route('buyer.profile')}}">
                                ...
                                <div class="dropdown-user">
                                    <ul class="dropdown-user__list">
                                        <li>
                                            <a class="dropdown-user__link" href="/plans/user-plans">Upgrade to <span
                                                    class="budget budget--white">PRO</span></a>
                                        </li>
                                    </ul>
                                    <ul class="dropdown-user__list">
                                        <li>
                                            <a class="dropdown-user__link" href="{{route('buyer.profile')}}">Profile</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-user__link"
                                                href="/syed-mahroof/collections/">Collections</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-user__link" href="/settings/notifications">
                                                Notifications
                                            </a>
                                        </li>
                                    </ul>

                                    <ul class="dropdown-user__list" style="padding: 10px 0px;">
                                        <li>
                                            <strong><a class="dropdown-user__link"
                                                    href="/settings/dashboard">Dashboard</a></strong>
                                        </li>
                                    </ul>
                        ...
                        <a href="{{ route('buyer.profile') }}"><strong
                                class="header-main__link hidden-sm">Profile</strong></a>
                    @else
                        <a href="{{ route('buyer.login') }}"><strong class="header-main__link hidden-sm">Log
                                in</strong></a>

                        <a href="{{ route('buyer.signup') }}"><strong class="header-main__link hidden-sm">Sign
                                Up</strong></a>
                    @endif
                ...
                <div class="header-main__bts">
                    <a href="{{ route('supplier.login') }}" class="button button--rounded">
                        Supplier
                    </a>
                    <a href="{{ route('buyer.login') }}" class="button button--outline--rounded">
                        Enquire Now
                    </a>
                </div>
            </div>
...
<header class="site__header d-lg-block d-none">
    <div class="site-header"><!-- .topbar -->
                ...
                <div class="topbar__row">
                    ...
                    <div class="topbar__item">
                        <div class="topbar-dropdown">
                            <button class="topbar-dropdown__btn" type="button">Supplier
        ...
        <div class="site-header__middle container">
            <div class="site-header__logo"><a href="index.html"><!-- logo --> <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <ul class="departments__links">
                                                @foreach ($categories as $category)
                                                    <li class="departments__item">
                                                        <a class="departments__item-link" href="#">{{ $category->name }}</a>
                        ...
                        <div class="nav-panel__nav-links nav-links">
                            <ul class="nav-links__list">
                                <li class="nav-links__item nav-links__item--has-submenu"><a
                                        class="nav-links__item-link" href="{{ route('buyer.home') }}">
                                ...
                                <li class="nav-links__item nav-links__item--has-submenu"><a
                                        ...
                                        <div class="nav-links__item-body">Megamenu <svg class="nav-links__item-arrow"
                                                width="9px" height="6px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-down-9x6">
                                                </use>
                                            </svg></div>
                                            ...
                                            <div class="menu menu--layout--classic">
                                                ...
                                                <ul class="menu__list">
                                                    ...
                                                    <li class="menu__item">
                                                        ...
                                                        <div class="menu__item-submenu-offset"></div><a
                                                            class="menu__item-link"
                                                            href="{{ route('buyer.logout') }}">Logout</a>
                                                    </li>
                                                </ul>
                                            </div><!-- .menu / end -->
                                        </div>
                                ...
                                @else
                                    <li class="nav-links__item"><a class="nav-links__item-link"
                                            ...
                                            <div class="nav-links__item-body">Login</div>
                                        </a></li>
                                @endif
                                        ...
                                        <div class="menu menu--layout--classic">
                                            ...
                                            <ul class="menu__list">
                                                ...
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="post-without-sidebar.html">Post
                                                        Without
                                                        Sidebar</a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="menu menu--layout--classic">
                                            ...
                                            <ul class="menu__list">
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="{{ route('about') }}">About
                                                        Us</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="{{ route('contact') }}">Contact
                                                        Us</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="contact-us-alt.html">Contact Us
                                                        Alt</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                ...
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="terms-and-conditions.html">Terms
                                                        And
                                                        Conditions</a>
                                                </li>
                                                <li class="menu__item">
                                                ...
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="components.html">Components</a>
                                                </li>
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="typography.html">Typography</a>
                                                </li>
                                            </ul>
                                        </div><!-- .menu / end -->
                                    </div>
