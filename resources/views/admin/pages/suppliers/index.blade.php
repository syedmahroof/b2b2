                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            data-placeholder="Select option" data-dropdown-parent="#kt_menu_61a085084e0e0"
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="{{ route('admin.suppliers.show', $supplier->id) }}">
                                                    <div class="symbol-label">
                                                        <img src="{{ asset('assets/media/avatars/150-1.jpg') }}" alt="{{ $supplier->name }}"
                                                            class="w-100" />
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('admin.suppliers.show', $supplier->id) }}"
                                                    class="text-gray-800 text-hover-primary mb-1">{{ $supplier->name }}</a>
                                                <span>{{ $supplier->email }}</span>
                                            </div>
                                        </td>
                                        <td>{{ $supplier->role }}</td>
                                        <td>
                                            <div class="badge badge-light fw-bolder">{{ $supplier->last_login }}</div>
                                        </td>
                                        <td>{{ $supplier->joined }}</td>
                                        <td class="text-end">
                                            <a href="{{ route('admin.suppliers.edit', $supplier->id) }}"
                                                class="btn btn-light btn-active-light-primary btn-sm"
                                                data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                <!-- Add the SVG icon code here -->
                                            </a>
